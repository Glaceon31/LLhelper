...
@legacy_app.route("/llsaveunit/<content>", methods=['GET', 'POST'])
...
@legacy_app.route("/llsavesis/<content>", methods=['GET', 'POST'])
...
@legacy_app.route("/llsavesubmembers/<content>", methods=['GET', 'POST'])
...
@legacy_app.route("/llsaveallmembers/<content>", methods=['GET', 'POST'])
...
@legacy_app.route("/llloadnewsubmemberssis", methods=['GET', 'POST'])
...
@legacy_app.route("/llloadunit", methods=['GET', 'POST'])
def llunitload():
    print request.files
...
@legacy_app.route("/llloadnewunit-api", methods=['POST'])
...
@legacy_app.route("/llloadnewunit", methods=['GET', 'POST'])
def llnewunitload():
    print request.files
    for f in request.files['file']:
...
@legacy_app.route("/llloadnewunitsis", methods=['GET', 'POST'])
def llnewunitloadsis():
    print request.files
    for f in request.files['file']:
        return '<script>'+genllunitloadscript(f, sis=True)+'</script>'

@legacy_app.route("/llloadsis", methods=['GET', 'POST'])
def llnewsis():
    print("=====!==")
    print request.files
...
@legacy_app.route("/llunit", methods=['GET', 'POST'])
def llunit():
    ...
    return render_template("legacy/templates/llunit.html", data=result, cardsjson=cardsjson, songsjson=songsjson)


@legacy_app.route("/llnewunit", methods=['GET', 'POST'])
def llnewunit():
    ...
    return render_template("legacy/templates/llnewunit.html", cardsjson = cardsjson, songsjson = songsjson, additional_script=addon)

@legacy_app.route("/llnewunitsis", methods=['GET', 'POST'])
def llnewunitsis():
    argv = request.args.get("unit")
    addon = ""
    if argv:
    ...
    songsjson = open('newsongsjson.txt', 'rb').read()
    cardsjson = open('newcardsjson.txt', 'rb').read()
    return render_template("legacy/templates/llnewunitsis.html", cardsjson = cardsjson, songsjson = songsjson, additional_script=addon)

@legacy_app.route("/llnewautounit", methods=['GET', 'POST'])
def llnewautounit():
    songsjson = open('newsongsjson.txt', 'rb').read()
    cardsjson = open('newcardsjson.txt', 'rb').read()
    return render_template("legacy/templates/llnewautounit.html", cardsjson = cardsjson, songsjson = songsjson)

@legacy_app.route("/llnewunit40", methods=['GET', 'POST'])
def llnewunit40():
    songsjson = open('newsongsjson.txt', 'rb').read()
    cardsjson = open('newcardsjson4.txt', 'rb').read()
    return render_template("legacy/templates/llnewunit40.html", cardsjson = cardsjson, songsjson = songsjson)

@legacy_app.route("/llunitimport", methods=['GET', 'POST'])
def llunitimport():
    return render_template("legacy/templates/llunitimport.html")
