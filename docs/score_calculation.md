...
* `AccuracyGemFactor`：装备了判定宝石的成员，在被判定覆盖期间，该系数取值为0.33，加成到判定宝石对应的属性上。未被判定覆盖期间，该系数取值为0。与其它技能效果无特殊相互作用。[ref:存疑-判定宝石和其它技能的相互作用] [version:5.3:6.0]
...
* [refe:存疑-判定宝石和其它技能的相互作用] 尚不清楚判定宝石的加成和属性同步、属性提升之间有没有特殊相互作用。模拟计算中目前假定判定宝石和属性同步、属性提升无相互作用。 [version_from:5.3:6.0]
* [refe:存疑-判定宝石和其它技能的相互作用] 尚不清楚判定宝石的加成和属性同步、属性提升、溢出奶之间有没有特殊相互作用。模拟计算中目前假定溢出奶加成在判定宝石加成之上，判定宝石和属性同步、属性提升无相互作用。 [version:6.5:6.5]
